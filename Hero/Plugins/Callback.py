...
async def admin_risghts(_, CallbackQuery):
    ...
    if command == "pausecb":
        ...
        await CallbackQuery.message.reply_text(
            f"🎧 sᴇsʟɪ sᴏʜʙᴇᴛɪ ᴅᴜʀᴅᴜʀᴀɴ {CallbackQuery.from_user.mention}!",
    ...
    if command == "resumecb":
        ...
        await CallbackQuery.message.reply_text(
            f"🎧 sᴇsʟɪ sᴏʜʙᴇᴛɪ ᴅᴇᴠᴀᴍ ᴇᴛᴛɪʀᴇɴ {CallbackQuery.from_user.mention}!",
            reply_markup=audio_markup2,
        )
        await CallbackQuery.message.delete()
    ...
    if command == "stopcb":
        ...
        await CallbackQuery.message.reply_text(
            f"🎧 sᴇsʟɪ sᴏʜʙᴇᴛ ᴅᴜʀᴅᴜʀᴜʟᴅᴜ/sᴏʜʙᴇᴛɪ ᴅᴜʀᴅᴜʀᴀɴ {CallbackQuery.from_user.mention}!",
            reply_markup=audio_markup2,
        )
        await CallbackQuery.message.delete()
        ...
        if Queues.is_empty(chat_id):
            ...
            if str(finxx) == "raw":
                ...
                final_output = await CallbackQuery.message.reply_photo(
                    ...
                    caption=f"<b>__Sesli Sohbet Atlatıldı__</b>\n\n🎥<b>__Oynatılan:__</b> {title} \n⏳<b>__Süre:__</b> {duration_min} \n👤<b>__Oynatan:__ </b> {mention}",
                )
                await start_timer(
                    videoid,
                    duration_min,
            ...
            if str(finxx) == "s1s":
                ...
                final_output = await CallbackQuery.message.reply_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup(buttons),
                    caption=(
                        f"<b>__Atlatıldı__</b>\n\n🎥<b>__Şu an Oynatılan:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={videoid}) \n⏳<b>__Duration:__</b> {duration_min} Mins\n👤**__Ekleyen:__** {mention}"
                    ),
                )
                os.remove(thumb)
                await start_timer(
        ...
        for shikhar in _playlist:
            ...
            if await is_active_chat(chat_id):
                ...
                mystic = await mystic.edit(
                    f"**{MUSIC_BOT_NAME}Tarafından İndirildi**\n\n**Başlık:** {title[:50]}\n\n0% ▓▓▓▓▓▓▓▓▓▓▓▓ 100%"
                )
                downloaded_file = await loop.run_in_executor(
                    None, download, videoid, mystic, title
                )
