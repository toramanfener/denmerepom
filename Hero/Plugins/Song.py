...
__MODULE__ = "ᴍᴜᴢᴜᴋ ᴀʀᴀᴍᴀ"
__HELP__ = """


/song [ᴍᴜᴢᴜᴋ ɪsᴍɪ ᴠᴇʏᴀ ʏᴛ ʟɪɴᴋɪ] 
- sɪᴢɪɴ ɪᴄɪɴ ʙɪʀ ᴍᴜᴢɪᴋ ɪɴᴅɪʀɪʀ.

/bul [ᴍᴜᴢᴜᴋ ɪsᴍɪ ᴠᴇʏᴀ ʏᴛ ʟɪɴᴋɪ] 
- sɪᴢɪɴ ɪᴄɪɴ ʙɪʀ ᴍᴜᴢɪᴋ ɪɴᴅɪʀɪʀ.
...
async def play(_, message: Message):
    ...
    if url:
        ...
        if str(duration_min) == "None":
            return await mystic.edit("Afedersiniz! Canlı Video")
        await mystic.delete()
