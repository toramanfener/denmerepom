...
`/oynat` [ᴍᴜᴢɪᴋ ᴅᴏsʏᴀsɪɴɪ ʏᴀɴɪᴛʟᴀᴍᴀ] ᴏʀ [ʏᴛ ʟɪɴᴋ] ᴏʀ [ᴍᴜᴢɪᴋ ɪsᴍɪ]
- sᴇsʟɪ sᴏʜʙᴇᴛᴛᴇ ᴍᴜᴢɪᴋ ᴏʏɴᴀᴛɪʀ

`/vplay` [ᴠɪᴅᴇᴏ ʏᴀɴɪᴛʟᴀᴍᴀ] ᴏʀ [ʏᴛ ʟɪɴᴋ] ᴏʀ [ᴠɪᴅᴇᴏ ɪsᴍɪ]
- sᴇsʟɪ sᴏʜʙᴇᴛᴛᴇ ᴠɪᴅᴇᴏ ᴏʏɴᴀᴛɪʀ
